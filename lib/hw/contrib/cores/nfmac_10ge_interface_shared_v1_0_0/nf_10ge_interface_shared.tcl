...
# Set variables.
set design		 nfmac_10ge_interface_shared
...
read_verilog [glob -dir ./hdl/nfmac10g *.v]
...
#Add subcores
ipx::add_subcore xilinx.com:ip:ten_gig_eth_pcs_pma:5.0 [ipx::get_file_groups xilinx_verilogsynthesis -of_objects [ipx::current_core]]
ipx::add_subcore xilinx.com:ip:ten_gig_eth_pcs_pma:5.0 [ipx::get_file_groups xilinx_verilogbehavioralsimulation -of_objects [ipx::current_core]]
