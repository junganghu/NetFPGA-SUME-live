...
set design		 vlan_remover 
set top 		 vlan_remover
...
read_verilog "./hdl/vlan_remover_cpu_regs_defines.v"
read_verilog "./hdl/vlan_remover_cpu_regs.v"
read_verilog "./hdl/vlan_remover.v"
