...
set ::NF_DESIGN_DIR [lindex $argv 0]
...
create_ip -name nfmac_10ge_interface -vendor NetFPGA -library NetFPGA -module_name nf_10g_interface_ip
...
create_ip -name nfmac_10ge_interface_shared -vendor NetFPGA -library NetFPGA -module_name nf_10g_interface_shared_ip
...
create_bd_cell -type ip -vlnv NetFPGA:NetFPGA:nfmac_10ge_interface_shared:1.00 nf_10g_interface_0
create_bd_cell -type ip -vlnv NetFPGA:NetFPGA:nfmac_10ge_interface:1.00 nf_10g_interface_1
create_bd_cell -type ip -vlnv NetFPGA:NetFPGA:nfmac_10ge_interface:1.00 nf_10g_interface_2
create_bd_cell -type ip -vlnv NetFPGA:NetFPGA:nfmac_10ge_interface:1.00 nf_10g_interface_3
...
create_ip_run [get_files ./${proj_dir}/${design}.srcs/sources_1/ip/ten_gig_eth_pcs_pma_nonshared/ten_gig_eth_pcs_pma_nonshared.xci]
launch_runs ten_gig_eth_pcs_pma_nonshared_synth_1
wait_on_run ten_gig_eth_pcs_pma_nonshared_synth_1
...
create_ip_run [get_files ./${proj_dir}/${design}.srcs/sources_1/ip/ten_gig_eth_pcs_pma_shared/ten_gig_eth_pcs_pma_shared.xci]
launch_runs ten_gig_eth_pcs_pma_shared_synth_1
wait_on_run ten_gig_eth_pcs_pma_shared_synth_1
###
