...
set DEF_LIST {
	...
	{OUTPUT_PORT_LOOKUP 0 1 std/cores/nic_output_port_lookup_v1_0_0/data/output_port_lookup_regs_defines.txt} \
	{NF_10G_INTERFACE0 0 1 contrib/cores/nfmac_10ge_interface_shared_v1_0_0/data/nf_10g_interface_shared_regs_defines.txt} \
	{NF_10G_INTERFACE1 1 1 contrib/cores/nfmac_10ge_interface_v1_0_0/data/nf_10g_interface_regs_defines.txt} \
	{NF_10G_INTERFACE2 2 1 contrib/cores/nfmac_10ge_interface_v1_0_0/data/nf_10g_interface_regs_defines.txt} \
	{NF_10G_INTERFACE3 3 1 contrib/cores/nfmac_10ge_interface_v1_0_0/data/nf_10g_interface_regs_defines.txt} \
	{NF_RIFFA_DMA 0 1 std/cores/nf_riffa_dma_v1_0_0/data/nf_riffa_dma_regs_defines.txt} \

}

set target_path $::NF_DESIGN_DIR/sw/embedded/src/
...
source $::NF_DESIGN_DIR/hw/tcl/$::env(NF_PROJECT_NAME)_defines.tcl
