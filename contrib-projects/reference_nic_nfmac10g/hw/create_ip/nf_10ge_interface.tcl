...
create_ip -name ten_gig_eth_pcs_pma -vendor xilinx.com -library ip -version 5.0 -module_name ten_gig_eth_pcs_pma_nonshared
set_property -dict [list CONFIG.MDIO_Management {false}] [get_ips ten_gig_eth_pcs_pma_nonshared]
set_property -dict [list CONFIG.base_kr {BASE-R}] [get_ips ten_gig_eth_pcs_pma_nonshared]
set_property -dict [list CONFIG.SupportLevel $supportLevel] [get_ips ten_gig_eth_pcs_pma_nonshared]
