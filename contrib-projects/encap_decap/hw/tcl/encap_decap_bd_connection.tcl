...
connect_bd_net  [get_bd_pins vlan_adder_0/axis_aclk] [get_bd_pins sys_clock_0/clk_out2]
connect_bd_net  [get_bd_pins vlan_adder_0/axis_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
connect_bd_net  [get_bd_pins vlan_adder_0/S_AXI_ACLK] [get_bd_pins sys_clock_0/clk_out1]
connect_bd_net  [get_bd_pins vlan_adder_0/S_AXI_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
connect_bd_net  [get_bd_pins vlan_remover_0/axis_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
connect_bd_net  [get_bd_pins vlan_remover_0/S_AXI_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
connect_bd_net  [get_bd_pins vlan_remover_0/axis_aclk] [get_bd_pins sys_clock_0/clk_out2]
connect_bd_net  [get_bd_pins vlan_remover_0/S_AXI_ACLK] [get_bd_pins sys_clock_0/clk_out1]
connect_bd_net  [get_bd_pins axi_interconnect_0/M12_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
connect_bd_net  [get_bd_pins axi_interconnect_0/M13_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
connect_bd_net  [get_bd_pins axi_interconnect_0/M12_ACLK] [get_bd_pins sys_clock_0/clk_out1]
connect_bd_net  [get_bd_pins axi_interconnect_0/M13_ACLK] [get_bd_pins sys_clock_0/clk_out1]

connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M12_AXI] [get_bd_intf_pins vlan_adder_0/S_AXI]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M13_AXI] [get_bd_intf_pins vlan_remover_0/S_AXI]
...
connect_bd_intf_net [get_bd_intf_pins input_arbiter_0/m_axis] [get_bd_intf_pins vlan_remover_0/s_axis]
connect_bd_intf_net [get_bd_intf_pins vlan_remover_0/m_axis] [get_bd_intf_pins vlan_adder_0/s_axis]
connect_bd_intf_net [get_bd_intf_pins vlan_adder_0/m_axis] [get_bd_intf_pins nic_output_port_lookup_0/s_axis]
