...
#####################################
source ./tcl/encap_decap_defines.tcl
...
create_bd_cell -type ip -vlnv NetFPGA:NetFPGA:vlan_adder:1.00 vlan_adder_0
create_bd_cell -type ip -vlnv NetFPGA:NetFPGA:vlan_remover:1.00 vlan_remover_0
create_bd_cell -type ip -vlnv NetFPGA:NetFPGA:nic_output_port_lookup:4.00 nic_output_port_lookup_0
...
set_property -dict [list CONFIG.NUM_SI {2} CONFIG.NUM_MI {14}] [get_bd_cells axi_interconnect_0]

# Create external ports and make connection
source ./tcl/encap_decap_bd_port.tcl
source ./tcl/encap_decap_bd_connection.tcl
...
create_bd_addr_seg -range ${VLAN_ADDER_SIZEADDR} -offset ${VLAN_ADDER_BASEADDR} [get_bd_addr_spaces mbsys/microblaze_0/Data] \
   [get_bd_addr_segs vlan_adder_0/S_AXI/reg0] SEG_vlan_adder_0_reg0
create_bd_addr_seg -range ${VLAN_ADDER_SIZEADDR} -offset ${VLAN_ADDER_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_riffa_dma_0/m_axi_lite] \
   [get_bd_addr_segs vlan_adder_0/S_AXI/reg0] SEG_vlan_adder_0_reg0

create_bd_addr_seg -range ${VLAN_REMOVER_SIZEADDR} -offset ${VLAN_REMOVER_BASEADDR} [get_bd_addr_spaces mbsys/microblaze_0/Data] \
   [get_bd_addr_segs vlan_remover_0/S_AXI/reg0] SEG_vlan_remover_0_reg0
create_bd_addr_seg -range ${VLAN_REMOVER_SIZEADDR} -offset ${VLAN_REMOVER_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_riffa_dma_0/m_axi_lite] \
   [get_bd_addr_segs vlan_remover_0/S_AXI/reg0] SEG_vlan_remover_0_reg0
