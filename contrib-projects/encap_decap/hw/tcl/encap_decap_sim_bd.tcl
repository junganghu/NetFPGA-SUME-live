...
#TODO for testing -- change this 
#set test_name "both_all_match" 

#####################################
# Read IP Addresses and export registers
#####################################
source $::env(NF_DESIGN_DIR)/hw/tcl/encap_decap_defines.tcl
...
set_property -dict [list CONFIG.NUM_SI {1} CONFIG.NUM_MI {5}] $axi_interconnect_0


## Create external ports and make connection
source $::env(NF_DESIGN_DIR)/hw/tcl/encap_decap_bd_port_sim.tcl
source $::env(NF_DESIGN_DIR)/hw/tcl/encap_decap_bd_connection_sim.tcl
...
create_bd_addr_seg -range ${VLAN_ADDER_SIZEADDR} -offset ${VLAN_ADDER_BASEADDR} [get_bd_addr_spaces nf_sim_dma/axi_sim_transactor_ip/M_AXI] \
   [get_bd_addr_segs nf_sim_datapath/vlan_adder_0/S_AXI/reg0] SEG_vlan_adder_0_reg0

create_bd_addr_seg -range ${VLAN_REMOVER_SIZEADDR} -offset ${VLAN_REMOVER_BASEADDR} [get_bd_addr_spaces nf_sim_dma/axi_sim_transactor_ip/M_AXI] \
   [get_bd_addr_segs nf_sim_datapath/vlan_remover_0/S_AXI/reg0] SEG_vlan_remover_0_reg0
...
# add signals of interest to the wave diagram


add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/input_arbiter_0/inst}}

add_wave_divider output_port_lookup
add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/nic_output_port_lookup_0/inst}}
#add_wave_divider preprocess_control
#add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/nic_output_port_lookup_0/inst/preprocess_control}}
#add_wave_divider input_fifo
#add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/nic_output_port_lookup_0/inst/input_fifo}}
#add_wave_divider preprocess_fifo
#add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/nic_output_port_lookup_0/inst/preprocess_fifo}}
add_wave_divider output_queues
add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/output_queues_0/inst}}
#add_wave_divider HYPER_QUEUES_DATA
#add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/output_queues_0/inst/hyperq_output_fifo}} 
#add_wave_divider HYPER_QUEUES_META
#add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/output_queues_0/inst/hyperq_metadata_fifo}}
add_wave_divider VLAN_ADDER
add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/vlan_adder_0/inst}} 
add_wave_divider VLAN_IOQ
add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/vlan_adder_0/inst/input_fifo}} 

add_wave_divider VLAN_REMOVER
add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/vlan_remover_0/inst}} 
add_wave_divider VLAN_REMOVER_IOQ
add_wave {{/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/vlan_remover_0/inst/input_fifo}} 

add_force {/top_tb_bd/top_sim_bd_wrapper/encap_decap_i/nf_sim_datapath/nic_output_port_lookup_0/inst/ip2cpu_dstipmirror_reg} -radix bin {1 0ns}
