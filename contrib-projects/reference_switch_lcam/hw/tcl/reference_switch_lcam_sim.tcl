...
update_ip_catalog
create_ip -name lcam_output_port_lookup -vendor NetFPGA -library NetFPGA -module_name output_port_lookup_ip
...
set_property -dict [list CONFIG.INACTIVITY_TIMEOUT 12000] [get_ips barrier_ip]
